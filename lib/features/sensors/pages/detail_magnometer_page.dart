...
class DetailMagnoMeterPage extends StatelessWidget {
  const DetailMagnoMeterPage({super.key});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Detail Magnometer"),
        ),
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              BlocBuilder<MagnetometerBloc, SensorsState>(
